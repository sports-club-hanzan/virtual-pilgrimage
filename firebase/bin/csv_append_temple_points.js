...
async function main() {
    ...
    for (const data of records) {
        ...
        await axios.get('https://maps.googleapis.com/maps/api/directions/json?=&mode=walking&avoidHighways=false&avoidFerries=false&avoidTolls=false&key=AIzaSyAyPFAJTNbCbvIqyvMqAJMb5zvtr2bfroY' +
            '&origin=' + prev +
            '&destination=' + next
        )
            .then(response => {
