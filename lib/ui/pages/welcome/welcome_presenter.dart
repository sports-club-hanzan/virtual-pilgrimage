...
final WelcomePresenterProvider =
    StateNotifierProvider.autoDispose<WelcomePresenter, SignInState>(
  WelcomePresenter.new,
);

class WelcomePresenter extends StateNotifier<SignInState> {
  WelcomePresenter(
    this._ref,
  ) : super(
          SignInState(
