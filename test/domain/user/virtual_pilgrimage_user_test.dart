  ...
  group('VirtualPilgrimageUser', () {
    ...
    group('updateHealthInfo', () {
      test('health == null', () {
        ...
        // when
        final actual = target.updateHealth(health);
      ...
      test('health != null', () {
        ...
        final target = createUser(
          ...
          updateTime: DateTime(2023, 4, 1),
        );
        final health = HealthInfo(
          today: const HealthByPeriod(steps: 100, distance: 120, burnedCalorie: 130),
          // 無効な更新内容
          yesterday: const HealthByPeriod(steps: 200, distance: 0, burnedCalorie: 260),
          // 無効な更新内容
          week: const HealthByPeriod(steps: 0, distance: 100000, burnedCalorie: 0),
          month: const HealthByPeriod(steps: 12345, distance: 1789, burnedCalorie: 1111),
          updatedAt: CustomizableDateTime.current,
          totalSteps: 100000000000,
          totalDistance: 300000000,
        );
        ...
        final expected = target.copyWith(
          health: target.health!.copyWith(
            today: const HealthByPeriod(steps: 100, distance: 120, burnedCalorie: 130),
            // yesterday, week は入力値が無効だったので更新されない
            yesterday: HealthByPeriod.getDefault(),
            week: const HealthByPeriod(steps: 20000, distance: 24000, burnedCalorie: 26000),
            month: const HealthByPeriod(steps: 12345, distance: 1789, burnedCalorie: 1111),
            updatedAt: CustomizableDateTime.current,
